<nav class="bg-[#253a7d] text-white py-4 px-4 sm:px-8 flex items-center fixed w-full z-10">
    <div class="flex items-center justify-between w-full">
        ...
        <div class="hidden md:flex flex-1">
            <a href="/dashboard" class="px-5 py-4 text-white no-underline hover:bg-[#071952]/20 transition-colors duration-300 ease-in-out relative">
                Dashboard
                <span class="{{ request()->is('dashboard') ? 'underline' : '' }} underline-offset-8 decoration-2 decoration-cyan-300"></span>
            </a>
            <a href="/HalamanKatalog" class="px-5 py-4 text-white no-underline hover:bg-[#071952]/20 transition-colors duration-300 ease-in-out relative">
                Katalog
                <span class="{{ request()->is('HalamanKatalog') ? 'underline' : '' }} underline-offset-8 decoration-2 decoration-cyan-300"></span>
            </a>
            <a href="/TransaksiSaya" class="px-5 py-4 text-white no-underline hover:bg-[#071952]/20 transition-colors duration-300 ease-in-out relative">
                Transaksi
