    ...
    <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-md p-6">
        ...
        <form action="{{ route('admin.katalog.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="satuan" value="{{ old('satuan') }}" placeholder="contoh: botol, liter, pack, dll" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-accent" required>
            </div>
